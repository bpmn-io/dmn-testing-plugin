...
const CAMUNDA_PATH = path.resolve(__dirname, 'camundaDmnTestServer.jar') || path.resolve(__dirname, 'camunda/artefacts/camundaDmnTestServer.jar');
let camundaProcess;
...
async function main(app) {
  const {
    startCamunda,
    stopCamunda
  } = __webpack_require__(/*! ./camunda */ "./backend/camunda.js");
