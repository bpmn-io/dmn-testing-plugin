...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DecisionsDropdown; });
...
function DecisionsDropdown(props) {
  const {
    selected,
    decisions,
    onDecisionChanged
  } = props;
  const dropdownItems = decisions.map((decision, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", {
    key: index,
    value: decision.decisionId
  }, decision.decision));

  const onChange = event => onDecisionChanged(decisions.find(decision => decision.decisionId === event.target.value));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DmnTestingPlugin; });
...
/* harmony import */ var _TestingModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TestingModal */ "./client/TestingModal.js");
...
class DmnTestingPlugin extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props) {
    super(props);

    _defineProperty(this, "evaluateDmn", async ({
      decision,
      variables
    }) => {
      const {
      ...
      const engineAPI = new _EngineAPI__WEBPACK_IMPORTED_MODULE_4__["default"](ENGINE_ENDPOINT);
      let evaluation;

      try {
        const rawResults = await engineAPI.evaluateDecision({
          xml,
          decision,
          variables
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EngineAPI; });
class EngineAPI {
...
/***/ "./client/InputVariableHelper.js":
/*!***************************************!*\
  !*** ./client/InputVariableHelper.js ***!
  \***************************************/
/*! exports provided: getInputVariables */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInputVariables", function() { return getInputVariables; });
...
function getInputVariables(container) {
  // (1) get decisions
  const decisions = getDecisions(container); // (2) get downstream decisions

  const downstreamDecisions = getDownstreamDecisions(decisions); // (3) for each decision, map name, variables and their types. Also add the downstream decisions
...
function getDecisions(container) {
  return container.drgElement.filter(element => element && element.$type === 'dmn:Decision' && Object(dmn_js_shared_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_0__["is"])(element.decisionLogic, 'dmn:DecisionTable'));
}
/**
...
function getDownstreamDecisions(decisions) {
  ...
  decisions.forEach(decision => {
    let downstreamDecisions = decision.informationRequirement && decision.informationRequirement.length > 0 && decision.informationRequirement.filter(infoReq => infoReq.requiredDecision).length > 0 ? decision.informationRequirement.filter(infoReq => infoReq.requiredDecision).map(infoReq => infoReq.requiredDecision.href.slice(1)) : [];
  ...
  return downstreamDecisionMap; // helpers //////////
  ...
  function getTransientDecIds(decId, downstreamDecisionMap) {
    if (downstreamDecisionMap[decId] === undefined || downstreamDecisionMap[decId].length == 0) {
      ...
      return downstreamDecisionMap[decId].concat(downstreamDecisionMap[decId].map(transId => getTransientDecIds(transId, downstreamDecisionMap))).flat();
    }
  }
...
function isOutput(input, decisions) {
  if (input && input.inputExpression && input.inputExpression.text) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ResultsModal; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/camunda-modeler-plugin-helpers/react.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! camunda-modeler-plugin-helpers/components */ "./node_modules/camunda-modeler-plugin-helpers/components.js");
 // eslint-disable-line no-unused-vars
...
function ErrorResults(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Evaluation failed"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, error.message));
}
...
function SuccessResults(props) {
  ...
  const Results = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, results.map(decision => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    title: 'id: ' + decision.id
  }, decision.name, decision.outputs.length ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, decision.outputs.map(output => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    title: 'id: ' + output.id
  }, output.name, ": ", output.values.join(', ')))) : null)));

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Successfully evaluated decision"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Results per decision:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Results, null)));
}

/***/ }),

/***/ "./client/TestingModal.js":
/*!********************************!*\
  !*** ./client/TestingModal.js ***!
  \********************************/
/*! exports provided: default */
...
/* harmony import */ var _DecisionsDropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DecisionsDropdown */ "./client/DecisionsDropdown.js");
/* harmony import */ var camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! camunda-modeler-plugin-helpers/components */ "./node_modules/camunda-modeler-plugin-helpers/components.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class ConfigModal extends react__WEBPACK_IMPORTED_MODULE_0___default.a.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
      onClose: onClose
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_3__["Modal"].Title, null, "DMN Testing"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_3__["Modal"].Body, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Decision to evaluate"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DecisionsDropdown__WEBPACK_IMPORTED_MODULE_2__["default"], {
      selected: decisionTaken,
      decisions: decisions,
      onDecisionChanged: this.updateDecision
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Variable inputs"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_1__["Formik"], {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_1__["FieldArray"], {
      name: "variables",
    ...
    }))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_3__["Modal"].Footer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
/* harmony import */ var _DmnTestingPlugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DmnTestingPlugin */ "./client/DmnTestingPlugin.js");
/**
 * Copyright Camunda Services GmbH and/or licensed to Camunda Services GmbH
 * under one or more contributor license agreements. See the NOTICE file
 * distributed with this work for additional information regarding copyright
...
/*!**********************************************************!*\
  !*** ./node_modules/dmn-js-shared/lib/util/ModelUtil.js ***!
  \**********************************************************/
/*! exports provided: is, isInput, isOutput, isRule, getBusinessObject, getName, isAny */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isOutput", function() { return isOutput; });
